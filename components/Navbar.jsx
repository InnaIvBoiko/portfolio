...
export default function Navbar() {
    ...
    return (
        ...
        >
            <Link href="/" aria-label="Inna Boiko — home">
                <Logo className="text-xl" />
            </Link>

            {/* Inline links — md+ only */}
            ...
            <div className="flex items-center gap-3">
                ...
                <Button variant="accent" className="!py-2 !px-6 text-sm hidden md:inline-block" onClick={goToContact}>
                    {t('contact')}
                </Button>
                ...
                <button
                    ...
                    className="md:hidden inline-flex items-center justify-center w-10 h-10 rounded-full border border-current/20 hover:text-accent hover:border-accent/50 transition-colors"
                >
            ...
            {/* Mobile dropdown */}
            {menuOpen && (
                <div className="md:hidden absolute top-full left-0 right-0 mt-3 rounded-[1.75rem] border border-primary/10 bg-background/95 backdrop-blur-xl shadow-xl p-3 flex flex-col text-primary">
